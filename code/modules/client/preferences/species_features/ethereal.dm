...
/datum/preference/choiced/ethereal_face
	savefile_key = "feature_ethereal_face"
	savefile_identifier = PREFERENCE_CHARACTER
	category = PREFERENCE_CATEGORY_FEATURES
	main_feature_name = "Ethereal Face"
	should_generate_icons = TRUE

/datum/preference/choiced/ethereal_face/init_possible_values()
	return possible_values_for_sprite_accessory_list_for_body_part(
		GLOB.ethereal_face_list,
		"ethereal_face",
		list("FRONT"),
	)

/datum/preference/choiced/ethereal_face/apply_to_human(mob/living/carbon/human/target, value)
	target.dna.features["ethereal_face"] = value
